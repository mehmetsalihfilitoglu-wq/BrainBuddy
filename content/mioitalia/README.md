...
Original, IMAT-level questions authored editorially by Mioitalia. This is **primary intellectual
...
- These original questions live here (`content/mioitalia/`) and **never mix into** the official
...
| `origin` | string | always `"mioitalia_original"` |
...
| `author` | string | `"mioitalia_editorial"` |
...
A generator will emit `app/src/main/assets/mioitalia/questions.json` (kept separate from the official
