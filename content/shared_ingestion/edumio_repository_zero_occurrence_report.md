...
| ~~`barjin_release.jks`~~ → `edumio_release.jks` | **Untracked** local signing keystore | **RENAMED 2026-07-18** (bytes/certificate unchanged — same SHA-256; identity preserved). New name is brand-clean; no allowlist entry needed. |
