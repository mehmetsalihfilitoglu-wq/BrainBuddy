#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate English7 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
def main():
    packs = sorted(OUT_DIR.glob("lgs_eng7_pack_*.json"))
    total_questions = 0
    ...
    print("=" * 60)
    print("ENGLISH7 VALIDATION REPORT")
    print("=" * 60)
