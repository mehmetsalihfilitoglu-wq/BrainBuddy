#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Fen6 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"deney_yorumlama", "gozlem_yorumlama", "grafik_yorumlama", "tablo_yorumlama", "sebep_sonuc", "kavram_baglantisi", "cok_adinli_dusunme"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_fen6_pack_*.json"))
    total_questions = 0
