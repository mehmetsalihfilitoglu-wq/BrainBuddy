#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Fen3 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"deney_yorumlama", "gozlem_yorumlama", "grafik_yorumlama", "tablo_yorumlama", "sebep_sonuc", "kavram_baglantisi"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_fen3_pack_*.json"))
    total_questions = 0
