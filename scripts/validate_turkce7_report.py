#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate TURKCE7 packs and produce report."""
import json
from pathlib import Path
from collections import Counter

BASE = Path(__file__).resolve().parent.parent / "app/src/main/assets/lgs_import/turkce7"
NEW_GEN = {"paragraf_yorum", "paragraf_analiz", "metin_yorumlama", "cikarim", "karsilastirma", "mantik"}

def main():
    packs = list(BASE.glob("lgs_turkce7_pack_*.json"))
    total = 0
    topics = Counter()
    new_gen = 0
    parse_ok = 0
    ...
    print("=" * 60)
    print("TURKCE7 VALIDATION REPORT")
    print("=" * 60)
