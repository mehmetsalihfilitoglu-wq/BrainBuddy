#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Din7 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"ayet_hadis_yorumlama", "senaryo_ahlak", "kavram_cikarimi", "metin_analizi", "paragraf_yorumlama", "deger_cikarimi"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_din7_pack_*.json"))
    total_questions = 0
