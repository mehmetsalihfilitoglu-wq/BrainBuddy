#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Hayat2 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"senaryo_yorumlama", "gunluk_hayat_durumu", "dogru_davranis_buldurma", "sebep_sonuc", "deger_davranis_analizi", "yorum_gerektiren"}


def main():
    packs = sorted(OUT_DIR.glob("lgs_hayat2_pack_*.json"))
    total_questions = 0
    ...
    print("=" * 60)
    print("HAYAT2 VALIDATION REPORT")
    print("=" * 60)
