#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 7th Grade Science (Fen Bilimleri) question bank for BrainBuddy.
50 packs × 10 questions = 500 questions.
BrainBuddy Question Design Standard: experiment interpretation, data analysis, scenario-based.
"""
import json
import random
