#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Mat5 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"cok_adinli_islem", "gercek_hayat_senaryosu", "grafik_tablo_yorum", "mantik_yuruttme", "yorum_gerektiren"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_mat5_pack_*.json"))
    total_questions = 0
