#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Fen4 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"deney_yorumlama", "gozlem_yorumlama", "grafik_yorumlama", "tablo_yorumlama", "sebep_sonuc", "kavram_baglantisi", "cok_adimli_dusunme"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_fen4_pack_*.json"))
    total_questions = 0
