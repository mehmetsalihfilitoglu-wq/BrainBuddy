#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 4th Grade English question bank for EDUmio.
50 packs × 10 questions = 500 questions.
EDUmio Question Design Standard: dialogue completion, situation-response, reading comprehension, inference.
"""
import json
import random
