#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate English5 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"dialogue_completion", "situation_response", "reading_comprehension", "inference", "paragraph_interpretation", "visual_interpretation", "logical_response"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_eng5_pack_*.json"))
    total_questions = 0
    ...
    print("=" * 60)
    print("ENGLISH5 VALIDATION REPORT")
    print("=" * 60)
