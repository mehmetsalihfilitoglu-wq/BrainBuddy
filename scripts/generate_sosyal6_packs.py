#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 6th Grade Sosyal Bilgiler question bank for EDUmio.
50 packs × 10 questions = 500 questions.
EDUmio Question Design Standard: paragraf yorum, harita/grafik/tablo yorumlama, tarihsel analiz, sebep-sonuç.
"""
import json
import random
