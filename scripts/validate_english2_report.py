#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate English2 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"dialogue_completion", "situation_response", "picture_interpretation", "reading_comprehension", "meaning_inference"}


def main():
    packs = sorted(OUT_DIR.glob("lgs_eng2_pack_*.json"))
    total_questions = 0
    ...
    print("=" * 60)
    print("ENGLISH2 VALIDATION REPORT")
    print("=" * 60)
