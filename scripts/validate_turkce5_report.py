#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate Turkce5 packs and produce report. Compatible with QuestionPackImporter."""
import json
...
NEW_GEN_TYPES = {"paragraf_yorum", "cikarim", "metin_analizi", "karsilastirma", "mantik_yurutme", "gorsel_tablo_yorum"}

def main():
    packs = sorted(OUT_DIR.glob("lgs_turkce5_pack_*.json"))
    total_questions = 0
    ...
    print("=" * 60)
    print("TURKCE5 VALIDATION REPORT")
    print("=" * 60)
