#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 3rd Grade Hayat Bilgisi (Life Studies) question bank for BrainBuddy.
50 packs × 10 questions = 500 questions.
BrainBuddy Question Design Standard: senaryo tabanlı, günlük hayat durumları, yorum, sebep-sonuç, değer/davranış analizi.
"""
import json
import random
