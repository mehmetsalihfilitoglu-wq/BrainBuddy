#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate 4th Grade Mathematics question bank for BrainBuddy.
50 packs × 10 questions = 500 questions.
BrainBuddy Question Design Standard: yorum, çok adımlı işlem, gerçek hayat senaryosu, grafik/tablo yorumlama.
"""
import json
import random
