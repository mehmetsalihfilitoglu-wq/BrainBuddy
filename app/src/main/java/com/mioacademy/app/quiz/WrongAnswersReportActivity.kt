...
import com.mioacademy.app.databinding.ActivityWrongAnswersReportBinding
...
class WrongAnswersReportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileId = intent.getStringExtra(EXTRA_PROFILE_ID) ?: com.mioacademy.app.core.ActiveProfileManager.getActiveProfileId(this)
