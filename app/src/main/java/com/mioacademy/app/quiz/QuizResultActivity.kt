...
import com.mioacademy.app.core.WrongReviewAccessManager
import com.mioacademy.app.core.TopicCounts
import com.mioacademy.app.league.LeagueScoring
...
class QuizResultActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun encodeSession(s: com.mioacademy.app.quiz.QuizSession): String {
            val o = JSONObject()
        ...
        fun decodeSession(json: String?): com.mioacademy.app.quiz.QuizSession? {
            ...
            return try {
                ...
                com.mioacademy.app.quiz.QuizSession(
    ...
    private var session: com.mioacademy.app.quiz.QuizSession? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        analytics.recordSession(com.mioacademy.app.core.QuizSession(
            System.currentTimeMillis(), s.correctCount, s.totalCount, xpEarned
        ))

        if (s.totalCount >= com.mioacademy.app.quiz.QuestionRepository.MIN_QUESTIONS_PER_TEST) {
            ...
            val streakDays = com.mioacademy.app.core.GamificationStore(this).streakDays()
        ...
        if (showRetry && wrongIds.isNotEmpty()) {
            ...
            btnRemedial.setOnClickListener {
                startActivity(Intent(this, com.mioacademy.app.quiz.QuizActivity::class.java).apply {
    ...
    private fun showWrongAnswers(s: com.mioacademy.app.quiz.QuizSession, wrongIds: List<String>) {
        val repo = QuestionRepository(this)
        val allMap = repo.loadAllQuestions().associateBy { it.id }
