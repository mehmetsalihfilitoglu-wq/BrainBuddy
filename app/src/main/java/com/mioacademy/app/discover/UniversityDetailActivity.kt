...
class UniversityDetailActivity : AppCompatActivity() {
        ...
        if (uni.websiteUrl.isNotBlank()) {
            container.addView(MaterialButton(this).apply {
                ...
                backgroundTintList = android.content.res.ColorStateList.valueOf(
                    resources.getColor(R.color.emerald, theme))
                setOnClickListener { openUrl(uni.websiteUrl) }
            })
        }

        // Official-notice caveat
    ...
    private fun openUrl(url: String) {
        try {
            ...
            Toast.makeText(this, getString(R.string.discover_no_browser), Toast.LENGTH_SHORT).show()
        }
    }
