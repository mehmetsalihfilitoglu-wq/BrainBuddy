...
import com.mioacademy.app.ui.ProgressRingView
...
class StatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b.recyclerRecentTests.adapter = RecentTestsAdapter(recentList) { perf ->
            startActivity(Intent(this, com.mioacademy.app.quiz.PastTestDetailActivity::class.java).apply {
                putExtra(com.mioacademy.app.quiz.PastTestDetailActivity.EXTRA_TEST_ID, perf.quizId)
                putStringArrayListExtra(com.mioacademy.app.quiz.PastTestDetailActivity.EXTRA_QUESTION_IDS, ArrayList(perf.questionIds))
            })
        }
