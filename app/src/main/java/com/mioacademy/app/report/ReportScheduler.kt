...
object ReportScheduler {
    ...
    fun schedule(context: Context) {
        val prefs = com.mioacademy.app.core.EmailReportPrefs(context)
        ...
        if (prefs.isWeeklyReportEnabled()) {
            ...
            val intervalDays = if (frequency == com.mioacademy.app.core.EmailReportPrefs.FREQ_MONTHLY) 30L else 7L
