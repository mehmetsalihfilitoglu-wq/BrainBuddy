...
import com.mioacademy.app.databinding.ActivityAvatarShopBinding
import com.mioacademy.app.databinding.BottomSheetAvatarItemBinding
import com.mioacademy.app.databinding.ItemAvatarShopCardBinding
...
class AvatarItemAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        if (item.previewDrawableRes != 0) {
            ...
            holder.b.previewThumb.setBackgroundResource(com.mioacademy.app.R.drawable.avatar_bg_white)
        }
