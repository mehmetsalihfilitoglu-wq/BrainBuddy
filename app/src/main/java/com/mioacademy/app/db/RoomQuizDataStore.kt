...
import com.mioacademy.app.quiz.AnswerRecord
import com.mioacademy.app.quiz.Question
import com.mioacademy.app.quiz.QuizQualityPolicy
...
class RoomQuizDataStore(private val context: Context) {
    ...
    fun getLgsCandidatePoolWithQuality(
        subject: String,
        allowedTiers: List<String> = QuizQualityPolicy.PLAYABLE_TIERS_PRIMARY,
    ): List<com.mioacademy.app.db.LgsCandidateRow> = runBlocking(Dispatchers.IO) {
    ...
    /** Seeding runs only from [com.mioacademy.app.app.BrainBuddyApp]; this reports whether meta says seeded. */
