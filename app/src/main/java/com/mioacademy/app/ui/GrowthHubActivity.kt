...
class GrowthHubActivity : AppCompatActivity() {
    ...
    private fun buildCoachTools(container: LinearLayout) {
        ...
        container.addView(journeyCard(com.mioacademy.app.core.LearningJourney.milestones(this)))
    }

    private fun planCard(steps: List<com.mioacademy.app.core.StudyPlanEngine.Step>): MaterialCardView {
        val col = paddedCol()
    ...
    private fun learningStatesCard(s: com.mioacademy.app.quiz.WrongQuestionScheduler.LearningStates): MaterialCardView {
        val row = LinearLayout(this).apply {
            orientation = LinearLayout.HORIZONTAL
            layoutParams = LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
    ...
    private fun heatmapCard(d: com.mioacademy.app.core.StudyHeatmap.Data): MaterialCardView {
        val col = paddedCol()
    ...
    private fun journeyCard(milestones: List<com.mioacademy.app.core.LearningJourney.Milestone>): MaterialCardView {
        val col = paddedCol()
