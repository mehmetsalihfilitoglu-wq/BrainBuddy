...
import com.mioacademy.app.db.GateFailedQuestionUpgrader
import com.mioacademy.app.db.PoolQuotaEnforcer
import com.mioacademy.app.quiz.QualityAudit
import com.mioacademy.app.db.QuestionDao
import com.mioacademy.app.quiz.QuestionPackImporter
...
class PoolStatusActivity : AppCompatActivity() {
    ...
    private fun getPoolStatusGradeLabel(): String {
        ...
        return when (gradePrefs.getSelectedMode()) {
            com.mioacademy.app.core.LevelMode.LGS -> "LGS"
            com.mioacademy.app.core.LevelMode.GRADE -> {
        ...
        lifecycleScope.launch {
            val summary = withContext(Dispatchers.IO) {
                ...
                sb.append(if (mode == LevelMode.LGS) "Seçili Mod: LGS"
                    else if (selectedGrade == com.mioacademy.app.core.GradePrefs.GRADE_JUNIOR) "Seçili Sınıf: Junior"
