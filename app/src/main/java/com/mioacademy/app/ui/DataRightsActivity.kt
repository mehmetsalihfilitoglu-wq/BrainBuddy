...
import com.mioacademy.app.privacy.DataRightsProvider
import com.mioacademy.app.privacy.DeletionResult
import com.mioacademy.app.privacy.ExportResult
...
class DataRightsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        col.addView(actionCard(
            ...
            danger = false
        ) { startActivity(Intent(this, com.mioacademy.app.legal.LegalHubActivity::class.java)) }, cardParams())
