...
class SeedAuditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCopy.setOnClickListener {
            ...
            cm.setPrimaryClip(ClipData.newPlainText("EDUmio audit", text))
                    ...
                    lifecycleScope.launch {
                        ...
                        val result = withContext(Dispatchers.IO) {
                            ...
                            try {
                                ...
                                meta.set(com.mioacademy.app.db.AppMetaEntity("db_seed_version", "0"))
                                meta.set(com.mioacademy.app.db.AppMetaEntity("db_seeded", "false"))
