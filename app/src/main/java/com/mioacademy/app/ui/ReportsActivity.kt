...
import com.mioacademy.app.core.WrongReportUnlockStore
import com.mioacademy.app.databinding.ActivityReportsBinding
import androidx.core.content.FileProvider
import com.mioacademy.app.ads.RewardedAdManager
import com.mioacademy.app.quiz.PastTestDetailActivity
import com.mioacademy.app.quiz.QuizActivity
import com.mioacademy.app.report.PdfReportGenerator
import com.mioacademy.app.ui.BarChartView.BarData
...
class ReportsActivity : AppCompatActivity() {
    ...
    private fun applyModel(
        ...
        if (model.wrongReview.hasData) {
            ...
            val isPremium = com.mioacademy.app.core.PremiumStore(this).isPremium()
    ...
    private fun startWrongAnswersReportActivity(sinceMillis: Long) {
        startActivity(Intent(this, com.mioacademy.app.quiz.WrongAnswersReportActivity::class.java).apply {
            putExtra(com.mioacademy.app.quiz.WrongAnswersReportActivity.EXTRA_SINCE_MILLIS, sinceMillis)
            putExtra(com.mioacademy.app.quiz.WrongAnswersReportActivity.EXTRA_PROFILE_ID,
                com.mioacademy.app.core.ActiveProfileManager.getActiveProfileId(this@ReportsActivity))
        })
    }
    ...
    private class RecentTestsAdapter(
        private val snapshots: List<com.mioacademy.app.db.TestSnapshotEntity>,
        private val onItemClick: (com.mioacademy.app.db.TestSnapshotEntity) -> Unit
