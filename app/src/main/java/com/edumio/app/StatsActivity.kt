...
import com.edumio.app.quiz.QuestionRepository
...
import com.edumio.app.databinding.ActivityStatsBinding
import com.edumio.app.ui.BarChartView
import com.edumio.app.ui.LineChartView
import com.edumio.app.ui.ProgressRingView
...
class StatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (strongest.isEmpty()) {
            val chip = Chip(this, null, com.edumio.app.R.style.Widget_EDUmio_Chip_Stat).apply {
        ...
        b.recyclerRecentTests.adapter = RecentTestsAdapter(recentList) { perf ->
            startActivity(Intent(this, com.edumio.app.quiz.PastTestDetailActivity::class.java).apply {
                putExtra(com.edumio.app.quiz.PastTestDetailActivity.EXTRA_TEST_ID, perf.quizId)
                putStringArrayListExtra(com.edumio.app.quiz.PastTestDetailActivity.EXTRA_QUESTION_IDS, ArrayList(perf.questionIds))
            })
        }
