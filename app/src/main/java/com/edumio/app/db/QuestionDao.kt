...
interface QuestionDao {
    ...
    suspend fun getMixedImatPool(examSubject: String?): List<QuestionEntity>
    ...
    /**
     * Inactive rows whose [QuestionEntity.deactivationReason] matches [com.edumio.app.quiz.QuestionQualityGate]
