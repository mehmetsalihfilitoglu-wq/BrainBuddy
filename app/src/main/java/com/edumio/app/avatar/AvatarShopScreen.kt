...
import com.edumio.app.databinding.ActivityAvatarShopBinding
import com.edumio.app.databinding.BottomSheetAvatarItemBinding
import com.edumio.app.databinding.ItemAvatarShopCardBinding
...
class AvatarItemAdapter(
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        if (item.previewDrawableRes != 0) {
            ...
            holder.b.previewThumb.setBackgroundResource(com.edumio.app.R.drawable.avatar_bg_white)
        }
