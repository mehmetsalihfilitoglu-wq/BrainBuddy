...
import com.edumio.app.core.WrongReportUnlockStore
import com.edumio.app.databinding.ActivityReportsBinding
import androidx.core.content.FileProvider
import com.edumio.app.ads.RewardedAdManager
import com.edumio.app.quiz.PastTestDetailActivity
import com.edumio.app.quiz.QuizActivity
import com.edumio.app.report.PdfReportGenerator
import com.edumio.app.ui.BarChartView.BarData
...
class ReportsActivity : AppCompatActivity() {
    ...
    private fun startWrongAnswersReportActivity(sinceMillis: Long) {
        startActivity(Intent(this, com.edumio.app.quiz.WrongAnswersReportActivity::class.java).apply {
            putExtra(com.edumio.app.quiz.WrongAnswersReportActivity.EXTRA_SINCE_MILLIS, sinceMillis)
            putExtra(com.edumio.app.quiz.WrongAnswersReportActivity.EXTRA_PROFILE_ID,
                com.edumio.app.core.ActiveProfileManager.getActiveProfileId(this@ReportsActivity))
        })
    }
    ...
    private class RecentTestsAdapter(
        private val snapshots: List<com.edumio.app.db.TestSnapshotEntity>,
        private val onItemClick: (com.edumio.app.db.TestSnapshotEntity) -> Unit
