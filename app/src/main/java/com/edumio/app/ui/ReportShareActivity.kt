...
class ReportShareActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val to = EmailReportPrefs(this).reportEmail().ifBlank { null }
            ?: com.edumio.app.auth.AuthProvider.currentUser(this)?.email
            ?: ""
        ...
        startActivity(Intent.createChooser(intent, getString(com.edumio.app.R.string.report_share_prompt)))
        finish()
    }
}
