...
class GrowthHubActivity : AppCompatActivity() {
    ...
    private fun buildPremiumSection(container: LinearLayout, insights: ProgressInsights) {
        ...
        // The personal study-coach surfaces (today's plan / mastery / heatmap / journey) are not part of
        // v1 — the coach was removed. This premium section keeps only the readiness + interpretive cards.
    }
