...
import com.edumio.app.core.GradePrefs
import com.edumio.app.core.LevelMode
...
import com.edumio.app.db.GateFailedQuestionUpgrader
import com.edumio.app.db.PoolQuotaEnforcer
import com.edumio.app.quiz.QualityAudit
import com.edumio.app.db.QuestionDao
import com.edumio.app.quiz.QuestionPackImporter
...
class PoolStatusActivity : AppCompatActivity() {
    ...
    private fun getPoolStatusGradeLabel(): String {
        ...
        return when (gradePrefs.getSelectedMode()) {
            com.edumio.app.core.LevelMode.LGS -> "LGS"
            com.edumio.app.core.LevelMode.GRADE -> {
        ...
        lifecycleScope.launch {
            val summary = withContext(Dispatchers.IO) {
                ...
                sb.append(if (mode == LevelMode.LGS) "Seçili Mod: LGS"
                    else if (selectedGrade == com.edumio.app.core.GradePrefs.GRADE_JUNIOR) "Seçili Sınıf: Junior"
