...
class LeagueWeeklyWorker(
    ...
    override suspend fun doWork(): ListenableWorker.Result = withContext(Dispatchers.IO) {
        ...
        val analytics = com.edumio.app.core.AnalyticsStore(appContext)
        ...
        if (storedWeekStart > 0 && storedWeekStart < currentWeekStart) {
            ...
            val entries = buildLeaderboardEntries(
                studentId = com.edumio.app.core.ProfileStore(appContext).getCurrentProfileId(),
                studentName = com.edumio.app.core.ProfileStore(appContext).getProfile(com.edumio.app.core.ProfileStore(appContext).getCurrentProfileId())?.name ?: "Öğrenci",
    ...
    private fun computeStudentExpectedWeeklyScore(analytics: com.edumio.app.core.AnalyticsStore): Int {
